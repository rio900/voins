...
namespace Voins
{
    public sealed partial class UC_Jakiro_DualBreath : UserControl, IGameControl, IAnimationControl
    {
        Canvas _rootCanvas;
        ...
        public void ChengeFire()
        {
            ...
            {
                C_Ice.Visibility = Windows.UI.Xaml.Visibility.Visible;
                C_Fire.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
            }
            else
            {
                C_Ice.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
                C_Fire.Visibility = Windows.UI.Xaml.Visibility.Visible;
            }
        }
