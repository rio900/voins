...
namespace Voins
{
    public sealed partial class UC_Alchemist_UnstableConcoction : UserControl, IGameControl
    {
        Canvas _rootCanvas;
        ...
        public UC_Alchemist_UnstableConcoction()
        {
        ...
        public void ChengAngel(EAngel angel)
        {
            ...
            C_Colb.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
