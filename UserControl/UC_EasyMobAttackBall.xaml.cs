...
namespace Voins
{
    public sealed partial class UC_EasyMobAttackBall : UserControl, IGameControl
    {
        Canvas _rootCanvas;
        ...
        /// <summary>
        /// Другая картинка шарика
        /// 1 - красный
        /// </summary>
        /// <param name="type">Номер картинки</param>
        public void ViewBall(int type)
        {
            if (type == 1)
                C_Red.Visibility = Windows.UI.Xaml.Visibility.Visible;
            else if (type == 2)
                C_Bush.Visibility = Windows.UI.Xaml.Visibility.Visible;
        }
    }
}
